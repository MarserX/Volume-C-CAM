...
def run(args):
    ...
    ir_label_out_dir = os.path.join(args.round_out_dir, 'prediction', args.ir_label_out_dir)

    train_dataset = data.dataloader_prostate.ProstateAffinityDataset(args.infer_list,
    ...
    infer_dataset = data.dataloader_prostate.ProstateImageDataset(args.infer_list,
                                                       prostate_root=args.data_root,
                                                       crop_size=args.irn_crop_size,
    ...
    torch.save(model.module.state_dict(), os.path.join(args.round_out_dir, 'checkpoints', args.irn_weights_name))
...
if __name__ == "__main__":
    ...
    args.infer_list = 'data/train_all_valid_acdc.txt'
    it_n = 1
    print(f'round = {it_n}')
    args.currRound = it_n
