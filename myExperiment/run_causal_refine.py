...
if __name__ == "__main__":
    ...
    pyutils.Logger(args.log_name + 'causal_refine.log')
    print(vars(args))
    ...
    args.cam_out_dir = 'cam'
    args.ir_label_out_dir = 'ir_label'
    args.irn_weights_name = 'res50_irn.pth'
    args.save_rw_dir = 'rw'
    ...
    if not os.path.exists(os.path.join(args.round_out_dir, 'prediction/rw')):
        os.makedirs(os.path.join(args.round_out_dir, 'prediction/rw'))
